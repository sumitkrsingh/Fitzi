...
@implementation InterpretingPhaseView5
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView6 class]])
            evaluationView = (InterpretingPhaseView6 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView4"
                                                    owner:self options:nil];
    InterpretingPhaseView4 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView4 class]])
            indexView = (InterpretingPhaseView4 *)object;
    }
