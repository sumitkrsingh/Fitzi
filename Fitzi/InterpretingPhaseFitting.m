...
@implementation InterpretingPhaseFitting
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseFitting1 class]])
            evaluationView = (InterpretingPhaseFitting1 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView9"
                                                    owner:self options:nil];
    InterpretingPhaseView9 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView9 class]])
            indexView = (InterpretingPhaseView9 *)object;
    }
