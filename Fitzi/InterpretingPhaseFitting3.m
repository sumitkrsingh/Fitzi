...
@implementation InterpretingPhaseFitting3
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseFitting4 class]])
            evaluationView = (InterpretingPhaseFitting4 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseFitting2"
                                                    owner:self options:nil];
    InterpretingPhaseFitting2 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseFitting2 class]])
            indexView = (InterpretingPhaseFitting2 *)object;
    }
