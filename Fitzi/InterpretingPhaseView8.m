...
#import "InterpretingPhaseView8.h"
#import "InterpretingPhaseView7.h"

@implementation InterpretingPhaseView8
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView9"
                                                    owner:self options:nil];
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView9 class]])
            evaluationView = (InterpretingPhaseView9 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView7"
                                                    owner:self options:nil];
    InterpretingPhaseView7 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView7 class]])
            indexView = (InterpretingPhaseView7 *)object;
    }
