...
#import "Troubleshooting5.h"
#import "Troubleshooting4.h"

@implementation Troubleshooting5
...
//            evaluationView = (FitziIndexView *)object;
//    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"Troubleshooting4"
                                                    owner:self options:nil];
    Troubleshooting4 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[Troubleshooting4 class]])
            indexView = (Troubleshooting4 *)object;
    }
