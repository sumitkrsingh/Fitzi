...
#import "Troubleshooting4.h"
#import "Troubleshooting3.h"

@implementation Troubleshooting4
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"Troubleshooting5"
                                                    owner:self options:nil];
    for (id object in bundle) {
        if ([object isKindOfClass:[Troubleshooting5 class]])
            evaluationView = (Troubleshooting5 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"Troubleshooting3"
                                                    owner:self options:nil];
    Troubleshooting3 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[Troubleshooting3 class]])
            indexView = (Troubleshooting3 *)object;
    }
