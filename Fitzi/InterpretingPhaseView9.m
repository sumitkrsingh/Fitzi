...
#import "InterpretingPhaseView9.h"
#import "InterpretingPhaseView8.h"

@implementation InterpretingPhaseView9
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseFitting class]])
            evaluationView = (InterpretingPhaseFitting *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView8"
                                                    owner:self options:nil];
    InterpretingPhaseView8 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView8 class]])
            indexView = (InterpretingPhaseView8 *)object;
    }
