...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[FitEvolutionView_Additional class]])
             fitEvolutionView_Additional = (FitEvolutionView_Additional *) object;
    }
    [self addSubview:fitEvolutionView_Additional];
    fitEvolutionView_Additional.frame = CGRectMake(0.0, self.bounds.size.height, fitEvolutionView_Additional.bounds.size.width, fitEvolutionView_Additional.bounds.size.height);
    [UIView animateWithDuration:1.0
                     animations:^{
                         ...
                         fitEvolutionView_Additional.frame = self.frame;//CGRectMake(12.0,24.0, equationView1.bounds.size.width, (equationView1.bounds.size.height)-20.0);
                     }];
