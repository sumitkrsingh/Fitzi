...
@implementation Troubleshooting1
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[Troubleshooting2 class]])
            evaluationView = (Troubleshooting2 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"OperetingiPad2"
                                                    owner:self options:nil];
    OperetingiPad2 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[OperetingiPad2 class]])
            indexView = (OperetingiPad2 *)object;
    }
