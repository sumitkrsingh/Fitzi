...
#import "Troubleshooting1.h"

@implementation Troubleshooting2
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[Troubleshooting3 class]])
            evaluationView = (Troubleshooting3 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"Troubleshooting1"
                                                    owner:self options:nil];
    Troubleshooting1 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[Troubleshooting1 class]])
            indexView = (Troubleshooting1 *)object;
    }
