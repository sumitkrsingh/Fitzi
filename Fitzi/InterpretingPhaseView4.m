...
@implementation InterpretingPhaseView4
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView5 class]])
            evaluationView = (InterpretingPhaseView5 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView3"
                                                    owner:self options:nil];
    InterpretingPhaseView3 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView3 class]])
            indexView = (InterpretingPhaseView3 *)object;
    }
