...
@implementation InterpretingPhaseView6
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView7 class]])
            evaluationView = (InterpretingPhaseView7 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView5"
                                                    owner:self options:nil];
    InterpretingPhaseView5 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView5 class]])
            indexView = (InterpretingPhaseView5 *)object;
    }
