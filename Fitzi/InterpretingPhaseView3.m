...
@implementation InterpretingPhaseView3
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView4 class]])
            evaluationView = (InterpretingPhaseView4 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView2"
                                                    owner:self options:nil];
    InterpretingPhaseView2 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView2 class]])
            indexView = (InterpretingPhaseView2 *)object;
    }
