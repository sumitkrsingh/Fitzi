...
@implementation FitziProcessEvaluation12
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    for (id object in bundle) {
        if ([object isKindOfClass:[FitziProcessEvaluation13 class]])
            fitziProcessEvaluation13 = (FitziProcessEvaluation13 *)object;
    }
    [self addSubview:fitziProcessEvaluation13];
    [UIView animateWithDuration:1.0
                     animations:^{
                         ...
                         fitziProcessEvaluation13.frame = self.frame; // its final location
                     }];
}
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"FitEvolutionView11"
                                                    owner:self options:nil];
    FitEvolutionView11 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[FitEvolutionView11 class]])
            indexView = (FitEvolutionView11 *)object;
    }
