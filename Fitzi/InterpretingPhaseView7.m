...
#import "InterpretingPhaseView6.h"

@implementation InterpretingPhaseView7
...
- (IBAction) swipeUpDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView8"
                                                    owner:self options:nil];
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView8 class]])
            evaluationView = (InterpretingPhaseView8 *)object;
    }
...
- (IBAction) swipeDownDone:(id) sender
{
    ...
    NSArray *bundle = [[NSBundle mainBundle] loadNibNamed:@"InterpretingPhaseView6"
                                                    owner:self options:nil];
    InterpretingPhaseView6 *indexView;
    for (id object in bundle) {
        if ([object isKindOfClass:[InterpretingPhaseView6 class]])
            indexView = (InterpretingPhaseView6 *)object;
    }
